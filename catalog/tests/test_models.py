...
class AuthorModelTest(TestCase):
    ...
    @classmethod
    def setUpTestData(cls) -> None:
        # создаем данные, которыми будут пользоваться все методы теста
    ...
    def test_date_of_birth_label(self):
        ...
        self.assertEquals(field_label, 'borned')
    ...
    def test_object_name_is_last_name_comma_first_name(self):
        expected_object_name = '{0}, {1}'.format(self.author.last_name, self.author.first_name)
